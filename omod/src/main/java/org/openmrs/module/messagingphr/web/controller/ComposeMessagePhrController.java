...
@Controller
public class ComposeMessagePhrController {
	
	private boolean replyingTo=false;
	@RequestMapping(value = "/module/messagingphr/compose_message")
	...
	@RequestMapping(value="/module/messagingphr/reply_to_message", method=RequestMethod.POST)
