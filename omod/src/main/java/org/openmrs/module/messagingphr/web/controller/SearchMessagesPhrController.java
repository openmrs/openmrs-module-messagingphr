...
@Controller
public class SearchMessagesPhrController {

	@RequestMapping(value = "/module/messagingphr/search_messages")
	public void populateModel(HttpServletRequest request){
		
	}
	
	@RequestMapping(value="/module/messagingphr/search", method=RequestMethod.POST)
